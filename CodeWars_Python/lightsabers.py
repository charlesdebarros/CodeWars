...
# howManyLightsabersDoYouOwn # that
...
# No starting help here -- you'll need to know how to write a function that
# accepts a parameter and returns a value based on that parameter.
...
print(howManyLightsabersDoYouOwn('Zach'))
print(howManyLightsabersDoYouOwn('Adam'))
